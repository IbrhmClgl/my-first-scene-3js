...
(async function () {
  ...
  let envmapTexture = await new RGBELoader()
    ...
    .loadAsync('./assets/pizzo.hdr');
  envmap = pmrem.fromEquirectangular(envmapTexture).texture;

  let textures = {
    dirt: await new TextureLoader().loadAsync('texture/dirt.png'),
    dirt2: await new TextureLoader().loadAsync('texture/dirt2.jpeg'),
    grass: await new TextureLoader().loadAsync('texture/grass.jpeg'),
    sand: await new TextureLoader().loadAsync('texture/sand.jpeg'),
    water: await new TextureLoader().loadAsync('texture/water.jpeg'),
    stone: await new TextureLoader().loadAsync('texture/stone.png'),
  };
...
function tree(height, position) {
  ...
  const geo3 = new CylinderGeometry(0, 0.08, treeHeight, 3);
